...
$select = mysqli_query($database, "SELECT * FROM `service` Where `id` = '$serviceID'");
                        ...
                        <div class="col-md-12">
                            <div class="card mb-3">
                                ...
                                <div class="card-body pb-4">
                                    <input type="file" id="file-input" class="form-control" value="<?php echo $rec['image']; ?>" name="image">
                                    <small class="d-block text-muted mt-2">Only portrait or square images, 15M max and
                                    ...
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            ...
                                            <select class="form-select" name="category"
                                                ...
                                                <?php
                                            $selectCTG = mysqli_query($database, "SELECT * FROM `category` WHERE `categoryType` = 'service'");
                                             while($show = mysqli_fetch_array($selectCTG)){
                                                
                                            ?>

                                                <option  value="<?php echo $show['category'] ?>" <?php
                                                    if($show['category']==$rec['category']){echo 'Selected' ; } ?> >
                                                    <?php echo $show['category'] ?>
                                                </option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" Hidden name="serviceID" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description" class="form-control"
                                            value="<?php echo $rec['description'] ?>">
                                    </div>
                                ...
                                <div class="col-md-12 pt-4">
                                    ...
                                    <textarea class="form-control" name="detail" id=""
                                        rows="1"><?php echo $rec['detail'] ?></textarea>
                                </div>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="sticky-lg-top">
                        ...
                        <div class="card mb-3">
                            <div
                                class="card-header py-3 d-flex justify-content-between align-items-center bg-transparent border-bottom-0">
                                <h6 class="m-0 fw-bold">Visibility</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="Published" name="visibillity" <?php if($rec['Visibillity'] == 'Published'){ echo 'checked';} ?> >
                                        <label class="form-check-label"> Published</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="Hidden" name="visibillity" <?php if($rec['Visibillity'] == 'Hidden'){ echo 'checked';} ?>>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-group demo-tagsinput-area">
                                    <div class="form-line">
                                        <input type="text" name="tags" value="<?php echo $rec['tags'] ?>"
