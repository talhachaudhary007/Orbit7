        ...
        <div class="sidebar px-4 py-4 py-md-4 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        <a class="m-link active" data-bs-toggle="collapse" data-bs-target="#menu-service" href="#">
                            <i class="icofont-code-alt fs-5"></i> <span>Services</span> <span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span></a>
                            <!-- Menu: Sub menu ul -->
                            <ul class="sub-menu collapse show" id="menu-service">
                                <li><a class="ms-link "  href="service_add.php">Add Service </a></li>
                                <li><a class="ms-link "  href="service_edit.php">Edit Service </a></li>
                                <li><a class="ms-link active" href="service_list.php">Service List</a></li>
                                <li><a class="ms-link " href="service_detail.php">Service Details</a></li>
                            </ul>
                    </li>
                    <li class="collapsed">
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#categories" href="#">
                            ...
                            <ul class="sub-menu collapse" id="categories">
                                <li><a class="ms-link" href="categories_list.php">Categories List</a></li>
                                <li><a class="ms-link" href="categories_edit.php">Categories Edit</a></li>
                                <li><a class="ms-link" href="categories_add.php">Categories Add</a></li>
                            </ul>
                    </li>
                    <li class="collapsed">
